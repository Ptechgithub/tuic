...
EOF
    ...
    red "======================================================================================"
    red "Tuic proxy service installation complete"
    red "The tuic-client.json saved to /root/tuic/tuic-client.json"
    cat /root/tuic/tuic-client.json
    red "Clash Meta Client profile saved to /root/tuic/clash-meta.yaml"
    red "======================================================================================"
    yellow "Your config--> :  $url"
}
...
changeport(){
    ...
    yellow "The port has been successfully changed to：$port"
}
...
changeuuid(){
    ...
    yellow "The UUID has been successfully changed to：$uuid"
}
...
changepasswd(){
    ...
    yellow "The password has been successfully changed to：$passwd"
}
